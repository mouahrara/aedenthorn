...
Released on 4 September, 2026, for SMAPI 4.1.0 or later.
* Fixed an issue where money would reset to zero when a mid-day gain (e.g., a reward for a special order) caused the total to exceed the `int32` limit 🔧
